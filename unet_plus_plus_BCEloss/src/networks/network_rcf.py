...
class RCF(BaseNetwork):

    def __init__(self, config, in_channels=7, init_weights=True):
        super(RCF, self).__init__()
        self.edge_detect = RCFSOURCE(in_channels=in_channels)
...
class RCFSOURCE(nn.Module):
    # https://github.com/meteorshowers/RCF-pytorch
    def __init__(self, in_channels=7):
        super(RCFSOURCE, self).__init__()
        # lr 1 2 decay 1 0
