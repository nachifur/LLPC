# https://github.com/CN-zdy/MSU_Net
import torch
...
class MSUNetSOURCE(nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
        super(MSUNetSOURCE, self).__init__()
